...
<head>
    ...
    <link rel="shortcut icon" href="/WEB-INF/static/favicon.ico" type="image/x-icon" />
...
<script src="${pageContext.request.contextPath }/static/js/plugins/jquery/jquery.min.js?v=2.1.4"></script>
<script src="${pageContext.request.contextPath }/static/js/plugins/bootstrap/bootstrap.min.js?v=3.3.6"></script>
<script src="${pageContext.request.contextPath }/static/js/plugins/content.min.js?v=1.0.0"></script>
<script src="${pageContext.request.contextPath }/static/js/plugins/plugins/iCheck/icheck.min.js"></script>
<script>
