...
public class HttpClientUtil {
	...
	public int sendMsgUtf8(String Uid, String Key, String content,
			String mobiles) {
		...
		String result = sendHttpPost("http://utf8.sms.webchinese.cn", maps,
				"utf-8");
	...
	public int sendMsgGbk(String Uid, String Key, String content, String mobiles) {
		...
		maps.put("smsMob", mobiles);
		maps.put("smsText", content);
		String result = sendHttpPost("http://gbk.sms.webchinese.cn", maps,
				"gbk");
		return Integer.parseInt(result);
	}
